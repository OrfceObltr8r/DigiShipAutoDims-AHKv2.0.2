...
;===============================================================================================================================
        ...
        ScreenClear := False
        While (!ScreenClear) { ;So long as the page has text, keep imgSearch until screen is clear
        ...
        if WinActive("Shipments"){ ;checks if digital shipper is active
            ...
            Sleep 500
            ProcessParcel(Date, Weight, Length, Width, Height) ;The magic happens here
            sleep 500
